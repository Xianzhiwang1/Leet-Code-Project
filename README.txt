...
(here)[https://www.kaggle.com/code/prathameshbhalekar/svm-with-kernel-trick-from-scratch/notebook] is one implementation that I found online, which might be useful as a reference.
